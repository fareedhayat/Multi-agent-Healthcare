...
#     if "get_insurance_id_message" not in session_data:
#             return {
#                 "status": "show_message",
#                 "message": "Insurance Verification Agent: Retrieving the Insurance ID.",
#                 "next_field": "get_insurance_id_message"
#             }
...
#     if "verify_patient_coverage_message" not in session_data:
#             return {
#                 "status": "show_message",
#                 "message": "Insurance Verification Agent: Verifying if the service is covered in the Insurance.",
#                 "next_field": "verify_patient_coverage_message"
#             }
...
async def get_insurance_id(session_data: dict = None) -> str:
    ...
    if "get_insurance_message" not in session_data:
        return {
            "status": "show_message",
            "message": "Insurance Agent: Looking up insurance ID for patient",
            "next_field": "get_insurance_message"
        }
...
async def verify_patient_coverage(session_data: dict = None) -> Dict:
    ...
    if "verify_coverage_message" not in session_data:
        return {
            "status": "show_message",
            "message": "Insurance Agent: Verifying patient insurance coverage",
            "next_field": "verify_coverage_message"
        }
    ...
    monitoring_result = await monitor_insurance_verification(
        session_data=session_data,
        insurance_data={
            "patient_name": name,
            "insurance_found": True,
