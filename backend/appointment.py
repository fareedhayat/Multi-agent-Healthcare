...
#     if "schedule_appointment_message" not in session_data:
#         return {
#             "status": "show_message",
#             "message": "Appointment Agent: Starting the appointment scheduling process",
#             "next_field": "schedule_appointment_message"
#         }
...
#         await monitor_appointments(event.id, "created", original_details=original_details, session_data=session_data)
...
#     if "reschedule_appointment_message" not in session_data:
#         return {
#             "status": "show_message",
#             "message": "Appointment Agent: Starting the appointment rescheduling process",
#             "next_field": "reschedule_appointment_message"
#         }
...
#         await monitor_appointments(event.id, "rescheduled", original_details=original_details, session_data=session_data)
...
#     if "delete_appointment_message" not in session_data:
#         return {
#             "status": "show_message",
#             "message": "Appointment Agent: Starting the appointment cancelling process",
#             "next_field": "delete_appointment_message"
#         }
...
#     await monitor_appointments(session_data["appointment_id"], "deleted", current_details=current_details, session_data=session_data)
#     return (
...
async def schedule_appointment(session_data: dict = None) -> str:
    ...
    try:
        ...
        original_details = await get_event_details(event.id)
        monitoring_result = await monitor_appointments(
...
async def delete_appointment(session_data: dict = None) -> str:
    ...
    if "delete_appointment_message" not in session_data:
        return {
            "status": "show_message",
            "message": "Appointment Agent: Starting the appointment deletion process",
            "next_field": "delete_appointment_message"
        }
